...
<body>
    ...
    const activities = [{
            ...
            date: '2024-10-17',
            latitude: 10.3166183,
            longitude: -83.9221164
        },
        {
            name: 'Excursión a la montaña',
            date: '2024-10-18',
            latitude: 10.3236183,
            longitude: -83.9321164
        },
        {
            name: 'Visita a parque nacional',
            date: '2024-10-19',
            latitude: 10.3096183,
            longitude: -83.9121164
        },
        {
            name: 'Recorrido cultural',
            date: '2024-10-20',
            latitude: 10.3196183,
            longitude: -83.9421164
        },
        {
            name: 'Aventura en kayak',
            date: '2024-10-25',
            latitude: 10.3193683,
            longitude: -83.9231164
        }
    ];
    ...
    function addMarker(activity) {
        ...
        marker.addListener('click', function() {
            infoWindow.setContent(
                `<div><strong>${activity.name}</strong><br>${activity.date}<br>Lat: ${activity.latitude}<br>Lng: ${activity.longitude}</div>`
                );
    ...
    function filterActivities() {
        ...
        const filteredActivities = activities.filter(activity => {
            ...
            const distance = calculateDistance(activity.latitude, activity.longitude, selectedLatitude,
                selectedLongitude);
