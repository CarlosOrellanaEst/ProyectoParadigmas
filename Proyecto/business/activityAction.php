...
if (isset($_POST['update'])) {
    ...
    $attributeTBActivityArray = isset($_POST['attributeTBActivityArrayA']) ? $_POST['attributeTBActivityArrayA'] : [];
    $dataAttributeTBActivityArray = isset($_POST['dataAttributeTBActivityArrayA']) ? $_POST['dataAttributeTBActivityArrayA'] : [];
