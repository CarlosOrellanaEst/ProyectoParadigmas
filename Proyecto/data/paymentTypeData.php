...
class paymentTypeData extends Data {
    public function insertTbPaymentType($paymentType) {
        ...
        // Verificar si la cuenta bancaria ya existe y está activa
        $accountNumber = $paymentType->getAccountNumber();
        $SinpeNumber = $paymentType->getSinpeNumber();
    
        // Verificar si el número de cuenta bancaria ya existe y está activo
        ...
        // Verificar si el número de SINPE ya existe y está activo, si se ingresó
        ...
        // Obtener el último ID y preparar para la inserción o actualización
    ...
    public function updateTbPaymentType($paymentType) {
        ...
        // Verificar si el número de cuenta ya existe en otro registro activo
        ...
        // Verificar si el número de SINPE ya existe en otro registro activo (si no está vacío)
        if (!empty($newSinpeNumber)) {
            ...
            if ($existingSinpeId) {
                mysqli_close($conn);
                return null; // El número de SINPE ya está registrado y activo en otro registro
            }
        }
