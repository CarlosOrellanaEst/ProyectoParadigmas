...
function handleErrorResponse(response) {
  switch (response.error_code) {
    ...
    case "invalid_costa_rica_id":
      alert(
        "Error: La identificación de Costa Rica debe contener exactamente 9 dígitos."
      );
      break;
    case "invalid_foreign_id":
      alert(
        "Error: La identificación extranjera debe contener entre 6 y 12 caracteres alfanuméricos."
      );
      break;
    case "invalid_phone":
    ...
    case "phone_already_registered":
      alert("Error: El número de teléfono ya está registrado.");
      break;
    case "invalid_email":
